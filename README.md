...
简体中文 | [llm.txt](https://github.com/yyswys-yjyj/ngender-php-api/blob/main/llm.txt)
...
|功能|效果|说明|
|-|-|-|
|web访问|80/443端口访问|基础的web访问，并且在web端中就有API的大部分功能了|
|API|80/443端口访问|需要配置伪静态，关于接口信息在：https://apihelp.serveryyswys.top/8408398m0|
